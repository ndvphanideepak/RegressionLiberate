...
public class ManageFault {
	...
	public boolean selectDepartmentDropdown() {
		...
		passed = action.selectBy(AssignFaultDepartment_DropDown, "FLT-D-Premier Cust Faults");
	...
	public boolean clickonSignOffApplybutton() {
		...
		//By clearaction = By.xpath("//*[text() = 'Clear Action']//following::select[1]");
		//action.selectBy(clearaction, 3);
