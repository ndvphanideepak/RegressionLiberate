...
public class AmendProductISPFields {
	...
	public boolean enterdatatoUsernamePwd(String ispUserName) {
		By productfieldvalue = By.xpath("//*[text() = 'Reward Points Added']//following::input[1]");
		boolean passed = false;
