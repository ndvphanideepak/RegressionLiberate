...
public class NewCustomer {
	...
	public boolean fillStandardAddress() {
		...
		boolean passed = false;
		By Address = By.xpath("//*[@id = 'createCustomerBusForm:addressTypeDetails']");
		action.selectBy(Address, "A-");
	...
	public boolean Address1() {
		boolean passed = false;
		By Address = By.xpath("(//*[@class = 'iceSelOneLb'])[2]");
		action.selectBy(Address, 1);
		return passed;
	}
	...
	public boolean billstatusarea() {
		boolean passed = false;
		passed = action.selectByPartialText(BillStatusArea_DropDown, "B01-B01");
	...
	public boolean fillContactDetails() {
		boolean passed = false;
		By sameasbilling_checkbox = By.xpath("//*[text() = 'Same as Billing:']//following::input[1]");
		By contactname = By.xpath("//*[text() = \"Contact Name:\"]//following::input[1]");
		...
		if (action.countOf(AddNewContact_Button) == 0) {
			...
			fillStandardAddress();
			action.clickOn(sameasbilling_checkbox);
		...
		action.sendDataTo(contactname, "Deepak");
		action.waitFor(3);
