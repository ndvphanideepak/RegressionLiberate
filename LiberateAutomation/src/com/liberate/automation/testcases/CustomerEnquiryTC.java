...
public class CustomerEnquiryTC {
	...
	public static String accountNumber = "290006960000";
	public static String surName = "Phani";
	public static String pricingPlanAccount = "290000540000";
	...
	public static void amendDayOfBilling() {
		...
		cr.navigate();
		action.getScreenShot(testCase);
		cr.searchByAccountNumber("290007040000");
		action.getScreenShot(testCase);
